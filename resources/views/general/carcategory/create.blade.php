    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">{{ __('Add new car`s category') }}</h4>
                            ...
                            <div class="row">
                                 ...
                                 <div class="col-md-6 col-lg-4 col-xl-6">
                                    ...
                                    <div class="form-group">
                                        <label for="">{{ __('Add new category') }} <span
                                 ...
                                 <div class="col-md-6 col-lg-4 col-xl-6">
                                    <div class="form-group">
                                        <label for="">{{ __('Lisance number') }} <span
                                                class="text-danger">*</span></label>
                                 ...
                                 <div class="col-md-6 col-lg-4 col-xl-6">
                                    ...
                                    <div class="form-group">
                                        <label for="">{{ __('Price for one day') }} <span
                                                class="text-danger">*</span></label>
