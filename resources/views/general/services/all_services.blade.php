...
<?php $lang = Session::get('locale'); ?>
    ...
    {{ __('roles.service_management') }}
@endsection
@section('content')
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">{{ __('roles.service_management') }}</h4>
                ...
                <div class="card-body">
                    <div class="input-group mb-3 d-flex justify-content-end">
                        ...
                        <button type="submit" name="bulk_action_btn" value="delete"
                            ...
                            @endcan
                        @can('create_service')
                        <a href="{{ route('admin.service.create') }}" class="btn btn-secondary mt-3 mr-2">
                        ...
                        @forelse ($services as $service)
                            <tr>
                                ...
                                <td class="text-center"> <span
                                        class="badge badge-pill {{ $service->status == 'active' ? 'badge-success' : 'badge-danger' }}">{{ $service->status }}</span>
                                </td>
