...
return [
    ...
    */
    ...
    'options' => [
         ...
         * Symbol, ZapfDingbats.
         */
        'font_dir' => storage_path(base_path("public/fonts")), // advised by dompdf (https://github.com/dompdf/dompdf/pull/782)
         ...
         * Note: This directory must exist and be writable by the webserver process.
         */
        'font_cache' => storage_path(base_path("public/fonts")),
         ...
         */
        'chroot' => realpath(base_path("public/fonts")),
